...
class TestApp:
    ...
    def test_show_articles_route(self, client):
    ...
    def test_increments_session_page_views(self, client):
        ...
        client.get('/articles/3')
        with client.session_transaction() as sess:
            assert sess['page_views'] == 3 # Should not increment on same article

    def test_limits_three_articles(self, client):
